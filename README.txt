...
a persistence unit "GestorProyectosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "GestorProyectos/pom.xml":
...
artifact ("GestorProyectos.war") is already built. You can build
